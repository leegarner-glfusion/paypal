...
'admin_hdr_attributes' => 'Attributes can be associated with products.  For instance, you may wish to offer small, medium and large sizes, and charge extra for large.<br /><span class="pluginPaypalAlertText">Note:  Products with attributs cannot be purchased via "Buy-Now" buttons.  The shopping cart must be enabled.</span>',
