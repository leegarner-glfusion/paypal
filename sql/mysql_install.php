...
$_SQL['paypal.products'] = "CREATE TABLE {$_TABLES['paypal.products']} (
  ...
  `shipping_amt` decimal(9,4) unsigned NOT NULL DEFAULT '0.00',
...
$_SQL['paypal.purchases'] = "CREATE TABLE {$_TABLES['paypal.purchases']} (
  ...
  `options_text` text,
  `extras` text,
  `shipping` decimal(9,4) NOT NULL default 0,
  `handling` decimal(9,4) NOT NULL default 0,
  PRIMARY KEY  (`id`),
...
$_SQL['paypal.coupons'] = "CREATE TABLE `{$_TABLES['paypal.coupons']}` (
  ...
  `amount` decimal(12,4) unsigned NOT NULL DEFAULT '0.00',
...
$PP_UPGRADE['0.6.0'] = array(
    ...
    "ALTER TABLE {$_TABLES['paypal.purchases']}
        ADD extras text,
        ADD `shipping` decimal(9,4) NOT NULL default 0,
        ADD `handling` decimal(9,4) NOT NULL default 0,
